 ...
 *
 * A renderer that cannot run the effect switches it off on top of that, and
 * that has to be checked anywhere the blur costs something, not just where it
 * draws: the output damages itself whole when a blurred surface is up, and
 * doing that while this returns %FALSE is all cost and no picture.
 *
